/**
 * Script de creación del esquema de base de datos para AppMarket.
 * 
 * Este archivo define la estructura completa de la base de datos del sistema
 * de marketplace, incluyendo todas las tablas, relaciones, índices y 
 * restricciones necesarias para el funcionamiento correcto de la aplicación.
 * 
 * Estructura de datos:
 * - Usuarios y autenticación
 * - Marketplace y categorías
...
-- =====================================================
-- TABLA: market_place
-- Descripción: Almacena la información del marketplace principal
-- =====================================================
...
-- =====================================================
-- TABLA: categories
-- Descripción: Categorías para clasificar productos
-- =====================================================
...
-- =====================================================
-- TABLA: users
-- Descripción: Usuarios del sistema con información personal y de autenticación
-- =====================================================
CREATE TABLE IF NOT EXISTS users (
    ...
    first_name VARCHAR(50) COMMENT 'Primer nombre del usuario',
    last_name VARCHAR(50) COMMENT 'Apellido del usuario',
    cedula VARCHAR(20) COMMENT 'Número de cédula o documento de identidad',
    address TEXT COMMENT 'Dirección física del usuario',
    role ENUM('USER', 'ADMIN', 'GUEST') DEFAULT 'USER' COMMENT 'Rol del usuario en el sistema',
...
) COMMENT = 'Usuarios del sistema con información personal y de autenticación';

-- =====================================================
-- TABLA: products
-- Descripción: Productos disponibles en el marketplace
-- =====================================================
CREATE TABLE IF NOT EXISTS products (
    ...
    category_id BIGINT COMMENT 'ID de la categoría del producto',
...
-- =====================================================
-- TABLA: product_likes
-- Descripción: Sistema de "me gusta" para productos
-- =====================================================
...
-- =====================================================
-- TABLA: contacts
-- Descripción: Sistema de contactos entre usuarios
-- =====================================================
...
-- =====================================================
-- TABLA: chats
-- Descripción: Salas de chat para comunicación entre usuarios
-- =====================================================
...
-- Descripción: Participantes de cada chat
-- =====================================================
...
-- =====================================================
-- TABLA: messages
-- Descripción: Mensajes enviados en los chats
-- =====================================================
...
-- =====================================================
-- TABLA: orders
-- Descripción: Órdenes de compra realizadas por usuarios
-- =====================================================
CREATE TABLE IF NOT EXISTS orders (
    ...
    status VARCHAR(20) DEFAULT 'PENDING' COMMENT 'Estado de la orden',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha de creación',
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Fecha de última actualización',
...
-- =====================================================
-- TABLA: order_items
-- Descripción: Items individuales dentro de cada orden
-- =====================================================
...
) COMMENT = 'Items individuales dentro de cada orden de compra';
...
CREATE TABLE IF NOT EXISTS payments (
    ...
    status VARCHAR(20) DEFAULT 'PENDING' COMMENT 'Estado del pago',
...
) COMMENT = 'Pagos realizados para las órdenes de compra';

-- =====================================================
-- DATOS INICIALES
-- Descripción: Inserción de datos básicos necesarios para el funcionamiento
-- =====================================================

-- Insertar marketplace principal si no existe
